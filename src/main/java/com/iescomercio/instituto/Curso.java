...
public class Curso {
    ...
    /**
     * Devuelve una representación en formato String del curso,
     * incluyendo la lista de alumnos matriculados.
     * 
     * @return Una cadena de texto con la información del curso.
     */
    @Override
     ...
     * 
     * @param p El objeto Persona que representa al alumno.
     */
